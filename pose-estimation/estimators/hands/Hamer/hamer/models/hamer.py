...
class HAMER(pl.LightningModule):
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        output['pred_mano_params'] = {
                        "global_orient": pred_mano_params['global_orient'].detach().cpu().numpy(),
                                                                    "hand_pose": pred_mano_params['hand_pose'].detach().cpu().numpy(),
                                            "betas": pred_mano_params['betas'].detach().cpu().numpy(),
        }
